...
class Micromouse:
    ...
    def processInput(self):
        ...
        for line in Lines:
            ...
            a=txt[1].split(")")
            a=a[0].split(",")
            # this was all to sort it the way PYAMAZE wants it to
            print("("+a[1]+", "+a[0]+")")
    ...
    def processDict(self):
        info = ['cell', 'E', 'W', 'N','S'] # headers
        items=self.dict.items()
        sortList=sorted(items) # sort items because of the list created needs to be in order
